...
test_spec = [{
    ...
    'expected': [
        ...
        {'name': 'Athens', 'cc': 'US', 'country': 'United States',
         'timezone': 'America/New_York', 'state': 'OH'},
        {'name': 'Athens', 'cc': 'US', 'country': 'United States',
    ...
    'input': (('Tehran',), {}),
    'expected': [
        {'name': 'Tehran', 'cc': 'IR', 'country': 'Iran',
         'timezone': 'Asia/Tehran', 'state': '26'},
    ]
}, {
    'input': (('Ath',), {'exact': True}),
    'expected': [
        {'name': 'Ath', 'cc': 'BE', 'country': 'Belgium',
         'timezone': 'Europe/Brussels', 'state': 'WAL'},
    ]
}, {
    ...
    'input': (('Madrid', 'SomeCountry'), {}),
    'expected': []
}, {
    'input': (('Pragu', 'Czechia'), {}),
    'expected': [{'name': 'Prague', 'cc': 'CZ', 'country': 'Czechia',
                  'state': '52', 'timezone': 'Europe/Prague'}, ]
}, {
    'input': (('Pragu', 'Czechia'), {'exact': True}),
    'expected': []
}, ]
