...
test_spec_units_simple = [lambda Q: {
    ...
    'results': [
        get_unit_result(Q)(
            '27.75 kilogram to pound', approxunits(Q(61.18, 'pound')),
    ...
    'results': [
        get_unit_result(Q)(
            '5400 second to hour', approxunits(Q(1.5, 'hour')),
...
test_spec_units_multi = [lambda Q: {
    ...
    'results': [
        get_unit_result(Q)(
            '10 centimeter to meter', approxunits(Q(0.1, 'meter')),
            '0.1 meter', '1 centimeter = 0.01 meter • [length]', order=0
        ),
        get_unit_result(Q)(
            '10 centimeter to inch', approxunits(Q(3.937, 'inch')),
            '3.93701 inch', '1 centimeter = 0.393701 inch • [length]', order=1
        ),
        get_unit_result(Q)(
            '10 centimeter to foot', approxunits(Q(0.3281, 'foot')),
    ...
    'results': [
        get_unit_result(Q)(
            ...
            approxunits(Q(6e+11, 'byte * centimeter / minute')),
...
test_spec_currency = [lambda Q, data: {
    ...
    'results': [
        get_unit_result(Q)(
            ...
            order=0, icon=images_dir('flags', 'EUR.svg')
        ),
        get_unit_result(Q)(
            ...
            order=1, icon=images_dir('flags', 'USD.svg')
        ),
        get_unit_result(Q)(
            ...
            order=2, icon=images_dir('flags', 'BTC.svg')
        ),
        get_unit_result(Q)(
    ...
    'results': [
        get_unit_result(Q)(
             ...
             order=0, icon=images_dir('flags', 'BTC.svg')
        ),
        get_unit_result(Q)(
    ...
    'results': [
        get_unit_result(Q)(
             ...
             order=0, icon=images_dir('flags', 'CAD.svg')
        ),
        get_unit_result(Q)(
            ...
            order=1, icon=images_dir('flags', 'EUR.svg')
        ),
        get_unit_result(Q)(
            ...
            order=2, icon=images_dir('flags', 'USD.svg')
        ),
        get_unit_result(Q)(
