...
def test_calculation_precision():
    ...
    assert calculation.value == pytest.approx(1)
    assert isinstance(calculation.value, complex)
    assert calculation.get_value() == pytest.approx(1)
    assert isinstance(calculation.get_value(), int)
...
def test_value_type():
    ...
    assert Calculation(1+0j).value_type == Calculation.VALUE_REAL
...
def test_format():
    ...
    assert Calculation(15.77555121551 - 11j).format() == '{:g} - {:g}i'.format(15.77555121551, 11)
    assert Calculation(77.95 + 1j).format() == '{:g} + i'.format(77.95)
    assert Calculation(2 + 0.4555754554j).format() == '{:g} + {:g}i'.format(2, 0.4555754554)
